      ...
      <aside>
        <div className="summary-card">
          ...
          <div className="health-row">
            ...
            <select id="calculation-date" className="method-select" aria-label={t.calculationDate} value={calculationDate} onChange={(event) => onCalculationDateChange(event.target.value)}>
